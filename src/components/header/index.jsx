...
import profileImg from '../../images/unnamed.jpg';

const classes = {
  wrapper: 'block mb-6 md:flex',
  imageWrapper: 'w-full max-w-200',
  image: 'rounded-full transform transition-all duration-200 hover:scale-105',
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <div className={classes.contentWrapper}>
        <h1 className={classes.name} style={{marginBottom: 13}}>
